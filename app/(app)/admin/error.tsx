...
export default function AdminError({ error, reset }: ErrorProps) {
  return (
    <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
      ...
      <h2 className="text-lg font-semibold text-zinc-300">Error al cargar el panel admin</h2>
      <p className="mt-2 max-w-sm text-sm text-zinc-500">
        Hubo un problema al conectar con la base de datos. Puede que las migraciones no estén aplicadas.
      </p>
      <button
        onClick={reset}
